export default function Clock({timeMs=0, percentageFilled=0, isRunning=false, setIsRunning}) {
    ...
    return (
        <div className="size-80 rounded-full bg-gradient-to-br from-darkerBackground from-20% to-lighterBackground max-w-96 flex justify-center items-center">
            <div className="size-[85%] flex flex-col justify-center items-center rounded-full bg-darkerBackground">
                <div className={`bg-[conic-gradient(theme(colors.theme1)_var(--gradient),0,theme(colors.darkerBackground))] flex flex-col justify-center items-center size-[93%] rounded-full`} style={{'--gradient': percentageFilled + "%"}}>
